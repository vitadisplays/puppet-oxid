...
license ''
project_page 'https://github.com/vitadisplays/puppet-oxid'
source 'https://github.com/vitadisplays/puppet-oxid'
summary 'This puppet module setups an oxid shop including mysql server, apache and php.'
